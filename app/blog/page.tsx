    ...
    <div className="w-full overflow-x-hidden" style={{ background: '#FAF9F6' }}>
      ...
      <section className="relative py-28 overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <FadeIn delay={0.2}>
            <p className="text-xl max-w-3xl mx-auto" style={{ color: '#72645A' }}>
      ...
      <section className="py-4 sticky top-16 z-40"
        style={{ background: 'rgba(255,255,255,0.92)', borderTop: '1px solid #E5DDD5', borderBottom: '1px solid #E5DDD5', backdropFilter: 'blur(16px)' }}>
      ...
      {/* Grid */}
      <section className="py-8 pb-24" style={{ background: '#FAF9F6' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <p className="text-xs font-black uppercase tracking-[0.25em] mb-8" style={{ color: '#ADA09A' }}>Latest Articles</p>
          </FadeIn>
            ...
            {rest.map(post => (
              <StaggerItem key={post.slug}>
                <Link href={`/blog/${post.slug}`}
                  ...
                  onMouseEnter={e => (e.currentTarget as HTMLElement).style.boxShadow = '0 12px 36px rgba(0,0,0,0.08)'}
      ...
      <section className="py-24 relative" style={{ background: '#FFFFFF', borderTop: '1px solid #E5DDD5' }}>
        ...
        <FadeIn className="max-w-3xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-[10px] mt-6 font-bold uppercase tracking-widest" style={{ color: '#D5CCBF' }}>
