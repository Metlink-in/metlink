...
function BrandIcon({ name }: { name: string }) {
  switch (name) {
    case 'monday.com':
      return <svg viewBox="0 0 36 12" width="52" height="18" fill="none"><circle cx="6" cy="6" r="6" fill="#F62B54"/><circle cx="18" cy="6" r="6" fill="#FDAB3D"/><circle cx="30" cy="6" r="6" fill="#00CA72"/></svg>;
    case 'Notion':
      return <svg viewBox="0 0 24 24" width="32" height="32"><path fill="white" d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L17.86 1.968c-.42-.326-.981-.7-2.055-.607L3.01 2.295c-.466.046-.56.28-.374.466zm.793 3.08v13.904c0 .747.373 1.027 1.214.98l14.523-.84c.841-.046.935-.56.935-1.167V6.354c0-.606-.233-.933-.748-.887l-15.177.887c-.56.047-.747.327-.747.933zm14.337.745c.093.42 0 .84-.42.888l-.7.14v10.264c-.608.327-1.168.514-1.635.514-.748 0-.935-.234-1.495-.933l-4.577-7.186v6.952L12.21 19s0 .84-1.168.84l-3.222.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.094-.42.14-1.026.793-1.073l3.456-.233 4.764 7.279v-6.44l-1.215-.139c-.093-.514.28-.887.747-.933zM1.936 1.035l13.31-.98c1.634-.14 2.055-.047 3.082.7l4.249 2.986c.7.513.934.653.934 1.213v16.378c0 1.026-.373 1.634-1.68 1.726l-15.458.934c-.98.047-1.448-.093-1.962-.747l-3.129-4.06c-.56-.747-.793-1.306-.793-1.96V2.667c0-.839.374-1.54 1.447-1.632z"/></svg>;
    case 'Klaviyo':
      return <svg viewBox="0 0 24 24" width="32" height="32"><path fill="#FFDE00" d="M16.63 19.2c.84.665 1.883 1.05 3.037 1.05H21V3.75h-1.333c-1.154 0-2.197.386-3.037 1.05l-8.04 6.313a1.875 1.875 0 000 2.774zM3 3.75v16.5h1.875V3.75H3z"/></svg>;
    case 'OpenAI':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="white"><path d="M22.282 9.821a5.985 5.985 0 0 0-.516-4.91 6.046 6.046 0 0 0-6.51-2.9A6.065 6.065 0 0 0 4.981 4.18a5.985 5.985 0 0 0-3.998 2.9 6.046 6.046 0 0 0 .743 7.097 5.98 5.98 0 0 0 .51 4.911 6.051 6.051 0 0 0 6.515 2.9A5.985 5.985 0 0 0 13.26 24a6.056 6.056 0 0 0 5.772-4.206 5.99 5.99 0 0 0 3.997-2.9 6.056 6.056 0 0 0-.747-7.073zM13.26 22.43a4.476 4.476 0 0 1-2.876-1.04l.141-.081 4.779-2.758a.795.795 0 0 0 .392-.681v-6.737l2.02 1.168a.071.071 0 0 1 .038.052v5.583a4.504 4.504 0 0 1-4.494 4.494zM3.6 18.304a4.47 4.47 0 0 1-.535-3.014l.142.085 4.783 2.759a.771.771 0 0 0 .78 0l5.843-3.369v2.332a.08.08 0 0 1-.033.062L9.74 19.95a4.5 4.5 0 0 1-6.14-1.646zM2.34 7.896a4.485 4.485 0 0 1 2.366-1.973V11.6a.766.766 0 0 0 .388.676l5.815 3.355-2.02 1.168a.076.076 0 0 1-.071 0l-4.83-2.786A4.504 4.504 0 0 1 2.34 7.872zm16.597 3.855l-5.833-3.387L15.119 7.2a.076.076 0 0 1 .071 0l4.83 2.791a4.494 4.494 0 0 1-.676 8.105v-5.678a.79.79 0 0 0-.407-.667zm2.01-3.023l-.141-.085-4.774-2.782a.776.776 0 0 0-.785 0L9.409 9.23V6.897a.066.066 0 0 1 .028-.061l4.83-2.787a4.5 4.5 0 0 1 6.68 4.66zm-12.64 4.135l-2.02-1.164a.08.08 0 0 1-.038-.057V6.075a4.5 4.5 0 0 1 7.375-3.453l-.142.08L8.704 5.46a.795.795 0 0 0-.393.681zm1.097-2.365l2.602-1.5 2.607 1.496v2.999l-2.597 1.5-2.607-1.5z"/></svg>;
    case 'Claude':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="#D4A27F"><path d="M4.709 15.955l4.72-2.647.08-.23-.08-.128-4.72.128v2.877zm14.583-8.966l-3.943 1.004-.106.127.085.152 3.974.884-.01-2.167zM12 .012C5.373.012 0 5.373 0 12c0 6.626 5.373 12 12 12 6.626 0 12-5.373 12-12 0-6.626-5.373-12-12-12zM9.009 16.97c-.375.23-.93.286-1.36.152l-4.166-2.486c-.43-.26-.591-.767-.358-1.138l2.45-4.047c.23-.382.77-.498 1.198-.27l4.047 2.295 1.037-.695-1.037-3.98c-.117-.463.118-.95.577-1.082l4.684-1.333c.46-.13.934.148 1.06.624l1.33 4.686c.13.46-.148.934-.624 1.06l-3.98 1.036-.696 1.038 2.295 4.047c.228.43.114.97-.27 1.198l-4.048 2.45c-.38.23-.872.158-1.137-.358l-2.486-4.167-.23-1.36.845-1.434-.846-.692z"/></svg>;
    case 'n8n':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="none"><circle cx="5" cy="12" r="3.5" fill="#EA4B71"/><circle cx="19" cy="12" r="3.5" fill="#EA4B71"/><circle cx="12" cy="5" r="3.5" fill="#FF6B9A"/><circle cx="12" cy="19" r="3.5" fill="#FF6B9A"/><line x1="8.5" y1="12" x2="15.5" y2="12" stroke="#EA4B71" strokeWidth="1.5"/><line x1="12" y1="8.5" x2="12" y2="15.5" stroke="#EA4B71" strokeWidth="1.5"/></svg>;
    case 'Make':
      return <svg viewBox="0 0 24 21" width="34" height="30" fill="none"><rect x="0" y="0" width="24" height="5" rx="2.5" fill="#7B2FF7"/><rect x="0" y="8" width="24" height="5" rx="2.5" fill="#A855F7"/><rect x="0" y="16" width="24" height="5" rx="2.5" fill="#C084FC"/></svg>;
    case 'Zapier':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="#FF4A00"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.016 13.5h-3.532l2.496 2.497-1.48 1.48L12 15l-2.5 2.477-1.48-1.48L10.516 13.5H7.016v-3h3.5L8.02 8.003l1.48-1.48L12 9l2.5-2.477 1.48 1.48L13.484 10.5h3.532v3z"/></svg>;
    case 'Slack':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="none"><path fill="#E01E5A" d="M5.042 15.165a2.528 2.528 0 01-2.52 2.523A2.528 2.528 0 010 15.165a2.527 2.527 0 012.522-2.52h2.52v2.52zm1.271 0a2.527 2.527 0 012.521-2.52 2.527 2.527 0 012.521 2.52v6.313A2.528 2.528 0 018.834 24a2.528 2.528 0 01-2.521-2.522v-6.313z"/><path fill="#36C5F0" d="M8.834 5.042a2.528 2.528 0 01-2.521-2.52A2.528 2.528 0 018.834 0a2.527 2.527 0 012.521 2.522v2.52H8.834zm0 1.271a2.528 2.528 0 012.521 2.521 2.528 2.528 0 01-2.521 2.521H2.522A2.528 2.528 0 010 8.834a2.527 2.527 0 012.522-2.521h6.312z"/><path fill="#2EB67D" d="M18.956 8.834a2.528 2.528 0 012.522-2.521A2.528 2.528 0 0124 8.834a2.528 2.528 0 01-2.522 2.521h-2.522V8.834zm-1.271 0a2.528 2.528 0 01-2.523 2.521 2.527 2.527 0 01-2.52-2.521V2.522A2.527 2.527 0 0115.162 0a2.528 2.528 0 012.523 2.522v6.312z"/><path fill="#ECB22E" d="M15.165 18.956a2.528 2.528 0 012.523 2.522A2.528 2.528 0 0115.165 24a2.527 2.527 0 01-2.52-2.522v-2.522h2.52zm0-1.271a2.527 2.527 0 01-2.52-2.523 2.526 2.526 0 012.52-2.52h6.313A2.527 2.527 0 0124 15.162a2.528 2.528 0 01-2.522 2.523h-6.313z"/></svg>;
    case 'Stripe':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="#635BFF"><path d="M13.976 9.15c-2.172-.806-3.356-1.426-3.356-2.409 0-.831.683-1.305 1.901-1.305 2.227 0 4.515.858 6.09 1.631l.89-5.494C18.252.975 15.697 0 12.165 0 9.667 0 7.589.654 6.104 1.872 4.56 3.147 3.757 4.992 3.757 7.218c0 4.039 2.467 5.76 6.476 7.219 2.585.92 3.445 1.574 3.445 2.583 0 .98-.84 1.545-2.354 1.545-1.875 0-4.965-.921-6.99-2.109l-.9 5.555C5.175 22.99 8.385 24 11.714 24c2.641 0 4.843-.624 6.328-1.813 1.664-1.305 2.525-3.236 2.525-5.732 0-4.128-2.524-5.851-6.591-7.305z"/></svg>;
    case 'Supabase':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="#3ECF8E"><path d="M11.9 1.036c-.015-.986-1.26-1.41-1.874-.637L.764 12.05C-.33 13.427.65 15.455 2.409 15.455h9.579l.113 7.51c.015.985 1.259 1.408 1.873.636l9.262-11.653c1.093-1.375.113-3.403-1.645-3.403h-9.58L11.9 1.036z"/></svg>;
    case 'HubSpot':
      return <svg viewBox="0 0 24 24" width="32" height="32" fill="#FF7A59"><path d="M18.164 7.931V5.084a2.195 2.195 0 10-2.853 0v2.847a6.228 6.228 0 00-2.969 1.3L5.537 4.055a2.44 2.44 0 10-.883 1.341l7.697 5.13a6.28 6.28 0 00-.94 3.263 6.261 6.261 0 001.22 3.722l-2.49 1.754a1.998 1.998 0 10.77 1.595 1.99 1.99 0 00-.18-.825l2.49-1.754a6.258 6.258 0 004.587 1.987c3.452 0 6.25-2.797 6.25-6.249a6.255 6.255 0 00-5.894-6.288zm-1.156 9.521a3.27 3.27 0 110-6.541 3.27 3.27 0 010 6.541z"/></svg>;
    default:
          ...
          <div style={{ overflow: 'hidden' }}>
            <div style={{ display: 'flex', width: 'max-content', animation: 'scroll 50s linear infinite', alignItems: 'center', padding: '12px 0' }}>
              {[...integrations, ...integrations].map((name, i) => (
                <div key={i} className="inline-flex items-center gap-4 shrink-0 px-10">
                  <BrandIcon name={name} />
                  <span className="text-base font-semibold whitespace-nowrap" style={{ color: 'rgba(220,235,255,0.8)' }}>{name}</span>
                </div>
              ))}
            </div>
          </div>
