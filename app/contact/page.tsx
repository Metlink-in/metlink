    ...
    <div className="w-full overflow-x-hidden" style={{ background: '#FAF9F6' }}>
      ...
      <section className="relative py-28 overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <FadeIn delay={0.2}>
            <p className="text-lg text-[#72645A] max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-14">
            ...
            <FadeIn className="lg:col-span-2">
              ...
              <div className="p-6 rounded-2xl" style={{ background: '#FFFFFF', border: '1px solid #E5DDD5' }}>
                <p className="text-[10px] font-black uppercase tracking-[0.2em] mb-4" style={{ color: '#ADA09A' }}>Trusted By Industries</p>
                <div className="flex flex-wrap gap-2">
                  {['FinTech','Healthcare','E-Commerce','SaaS','Real Estate','Startups'].map(tag => (
                    <span key={tag}
                      className="px-3.5 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wider cursor-default transition-all hover:text-[#C84B30]"
                      style={{ background: '#FAF9F6', color: '#ADA09A', border: '1px solid #E5DDD5' }}>
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            <FadeIn delay={0.15} className="lg:col-span-3">
              <div className="rounded-3xl overflow-hidden"
                style={{ background: '#FFFFFF', border: '1px solid #E5DDD5', boxShadow: '0 4px 32px rgba(0,0,0,0.06)' }}>
                <div className="h-1" style={{ background: 'linear-gradient(90deg, #C84B30, #E8612A, #C84B30)' }} />
                    ...
                    <>
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid sm:grid-cols-2 gap-6">
                          <div>
                            <label className={labelCls} style={{ color: '#C84B30' }}>Full Name</label>
                            <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="John Smith" required
                              className="w-full px-4 py-3.5 rounded-xl text-sm focus:outline-none placeholder:text-[#D5CCBF] transition-all"
                              style={inputBase}
                              onFocus={e => (e.currentTarget.style.borderColor = 'rgba(200,75,48,0.45)')}
                              onBlur={e => (e.currentTarget.style.borderColor = '#E5DDD5')} />
                          </div>
                          <div>
                            <label className={labelCls} style={{ color: '#C84B30' }}>Company</label>
                        ...
                        <div>
                          <label className={labelCls} style={{ color: '#C84B30' }}>Work Email</label>
                        ...
                        <div>
                          <label className={labelCls} style={{ color: '#C84B30' }}>Project Details</label>
                          <textarea name="message" value={form.message} onChange={handleChange} rows={5}
                            placeholder="Describe your goals, challenges, and what success looks like..." required
                            className="w-full px-4 py-4 rounded-xl text-sm focus:outline-none placeholder:text-[#D5CCBF] resize-none transition-all"
                            style={inputBase}
                            onFocus={e => (e.currentTarget.style.borderColor = 'rgba(200,75,48,0.45)')}
                            onBlur={e => (e.currentTarget.style.borderColor = '#E5DDD5')} />
                        </div>
                        ...
                        <p className="text-center text-[10px] font-bold uppercase tracking-widest" style={{ color: '#ADA09A' }}>
