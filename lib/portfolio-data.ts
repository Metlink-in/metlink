...
export const projects: Project[] = [
  {
    ...
    solution:
      'We implemented a custom recommendation engine using collaborative filtering, automated inventory predictions, and a dynamic pricing algorithm that responds in real-time to market conditions.',
    results: [
